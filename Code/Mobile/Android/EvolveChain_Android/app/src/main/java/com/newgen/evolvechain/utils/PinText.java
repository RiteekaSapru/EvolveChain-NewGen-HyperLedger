...
/**
 * Created by onkar.gupta on 5/22/2018.
 *
 */

public class PinText extends android.support.v7.widget.AppCompatEditText {
    protected float mLineStroke = 1;
    protected float mLineStrokeSelected = 2;
    protected float mSpace = 5;
    protected float mTextBottomPadding = 8;
    ...
    public PinText(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mSpace = multi * mSpace;
        mTextBottomPadding = multi * mTextBottomPadding;
